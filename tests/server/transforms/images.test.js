			...
			.then(function($content) {
				$content.html().should.equal(
					'<figure class="article__image-wrapper ng-figure-reset article__main-image ng-media-wrapper">' +
						'<img class="article__image ng-media" src="https://image.webservices.ft.com/v1/images/raw/http%3A%2F%2Fcom.ft.imagepublish.prod.s3.amazonaws.com%2Ff14a7e9e-cc08-11e4-aeb5-00144feab7de?source=next&amp;fit=scale-down&amp;width=710" alt="">' +
			...
			.then(function($content) {
				$content.html().should.equal(
					...
					'<figure class="article__image-wrapper ng-figure-reset article__inline-image ng-pull-out ng-inline-element">' +
						'<img class="article__image" src="https://image.webservices.ft.com/v1/images/raw/http%3A%2F%2Fcom.ft.imagepublish.prod.s3.amazonaws.com%2F2ad940b2-cc01-11e4-aeb5-00144feab7de?source=next&amp;fit=scale-down&amp;width=600" alt="">' +
					'</figure>'
				);
			});
	});
	...
	it('should not show main image if `fullWidthMainImages` flag is off', function() {
		...
		return images($content, { fullWidthMainImages: false })
			.then(function($content) {
				$content.html().should.equal(
					'<figure class="article__image-wrapper ng-figure-reset article__inline-image ng-pull-out ng-inline-element">' +
						'<img class="article__image" src="https://image.webservices.ft.com/v1/images/raw/http%3A%2F%2Fcom.ft.imagepublish.prod.s3.amazonaws.com%2Ff14a7e9e-cc08-11e4-aeb5-00144feab7de?source=next&amp;fit=scale-down&amp;width=600" alt="">' +
						'<figcaption class="article__image-caption ng-meta">American staples old and new: from top, Campbell&#x2019;s Soup, hot dogs and kale. Below, Annie&#x2019;s Homegrown co-founder Annie Withey</figcaption>' +
					'</figure>'
				);
			});
