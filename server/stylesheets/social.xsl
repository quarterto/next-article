...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="social">
		<xsl:choose>
			<xsl:when test="$renderGiftSharing = 1">
				<a class="o-overlay-trigger o--if-js" data-o-overlay-gift-trigger="true" data-o-overlay-src="#overlay-for-o-share" data-o-overlay-id="overlay" data-o-overlay-compact="true" data-o-overlay-arrow-position="top">Share</a>

				<script type="text/template" id="overlay-for-o-share">
					<div data-o-component="o-share" data-o-share--js="true" class="o-share" data-o-share-title='' data-o-share-url='' data-o-share-titleExtra='' data-o-share-relatedTwitterAccounts="">
			...
			<xsl:otherwise test="$renderSocial = 1">
