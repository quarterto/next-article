...
describe('Byline', () => {
	...
	it('should wrap author in link',() => {
		...
		bylineTransform(byline, authors).should.equal('<a class="n-content-tag n-content-tag--link" href="/stream/authorsId/ABCD-efhsdf" data-trackable="author">George Parker</a>');
	});
	...
	it('should wrap multiple authors in links',() => {
		...
		bylineTransform(byline, authors).should.equal(
			'<a class="n-content-tag n-content-tag--link" href="/stream/authorsId/ABCD-efhsdf" data-trackable="author">George Parker</a>' +
			' and ' +
			'<a class="n-content-tag n-content-tag--link" href="/stream/authorsId/OBCD-efhsdf" data-trackable="author">Chris Giles</a>'
		);
	});
