	...
	describe('Relative Links', function () {
		...
		it('should understand that article pages are article pages', function() {
			...
			$ = relativeLinksTransform($);
			expect($.html()).to.equal('<a href="/content/f3970f88-0475-11df-8603-00144feabdc0" title="Cadbury and Kraft agree &#xA3;11.6bn deal - FT.com">Cadbury was bought by <strong>Kraft</strong></a>');
		});
		...
		it('should support odd types of links', function() {
			...
			$ = relativeLinksTransform($);
			expect($.html()).to.equal('<a href="/content/6214279a-60eb-11de-aa12-00144feabdc0" title="BlackRock in new league with BGI deal - FT.com">bought the Barclays Global Investors</a>');
		});

		it('shouldn\' strip content after a relative link', function() {
			var $ = cheerio.load('<p>For Israelis and Lebanese, <a href=\"/content/9ffb1208-a6ef-11e4-8a71-00144feab7de\">Hizbollah&#x2019;s border attack</a> this week brought back uncomfortable memories of the start of their 2006 war, which left hundreds dead and ruined swaths of Lebanon.</p>');
			$ = relativeLinksTransform($);
			expect($.html()).to.equal('<p>For Israelis and Lebanese, <a href=\"/content/9ffb1208-a6ef-11e4-8a71-00144feab7de\">Hizbollah&#x2019;s border attack</a> this week brought back uncomfortable memories of the start of their 2006 war, which left hundreds dead and ruined swaths of Lebanon.</p>');
	});
