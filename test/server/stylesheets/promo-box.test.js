...
describe('Promo-boxes', function() {
		...
		.then(function (transformedXml) {
			transformedXml.should.equal(
				'<aside class="n-content-box n-content-box--inline n-content-u-border--all" data-trackable="related-box" role="complementary">' +
					'<div class="n-content-box__title"><div class="n-content-box__title-text n-content-u-background-color--pink">Tatomer Riesling 2012</div></div>' +
					'<div class="aside--headline n-content-u-margin--left-right">Greece debt crisis</div>' +
	...
	it('should transform to promo box - inline, expander - 4 paragraphs, 60 words, with image', function () {
		...
		.then(function (transformedXml) {
			transformedXml.should.equal(
				'<aside class="n-content-box n-content-box--inline n-content-u-border--all o-expander" data-trackable="related-box" role="complementary" data-o-component="o-expander" data-o-expander-shrink-to="0" data-o-expander-count-selector=".aside--content__extension">' +
					'<div class="n-content-box__title"><div class="n-content-box__title-text n-content-u-background-color--pink">Tatomer Riesling 2012</div></div>' +
					'<div class="aside--headline n-content-u-margin--left-right">Greece debt crisis</div>' +
					'<div class="aside--image">' +
						'<img alt="" src="https://next-geebee.ft.com/image/v1/images/raw/http://com.ft.imagepublish.prod.s3.amazonaws.com/1871b094-3b7d-11e5-bbd1-b37bc06f590c?source=next&amp;fit=scale-down&amp;width=470">' +
	...
	it('should leave in any HTML in title (except wrapped p tag)', function () {
		...
		.then(function(transformedXml) {
			transformedXml.should.equal(
				'<aside class="n-content-box n-content-box--inline n-content-u-border--all" data-trackable="related-box" role="complementary">' +
					'<div class="n-content-box__title"><div class="n-content-box__title-text n-content-u-background-color--pink"><a href="/c9175806-3054-11e5-8873-775ba7c2ea3d" data-trackable="link">Greece crisis tests start-ups’ staying power</a> </div></div>' +
				'</aside>\n'
			);
		});
	});
	...
	it('should leave in any HTML in headline (except wrapped p tag)', function () {
		...
		.then(function(transformedXml) {
			transformedXml.should.equal(
				'<aside class="n-content-box n-content-box--inline n-content-u-border--all" data-trackable="related-box" role="complementary">' +
					'<div class="aside--headline n-content-u-margin--left-right"><a href="/c9175806-3054-11e5-8873-775ba7c2ea3d" data-trackable="link">Greece crisis tests start-ups’ staying power</a></div>' +
				'</aside>\n'
			);
		});
	});
	...
	it('should not strip out text in a headline before a link', function() {
		...
		.then(function(transformedXml) {
			transformedXml.should.equal(
				'<aside class="n-content-box n-content-box--inline n-content-u-border--all" data-trackable="related-box" role="complementary">' +
					'<div class="n-content-box__title"><div class="n-content-box__title-text n-content-u-background-color--pink">Series: China Great Game</div></div>' +
					'<div class="aside--headline n-content-u-margin--left-right">As China seeks to expand its sphere of influence, it is likely to encounter significant resistance. <a href="http://www.ft.com/indepth/china-great-game" data-trackable="link">Read more</a> </div>' +
					'<div class="aside--content n-content-u-margin--left-right">' +
	...
	it('should accept a title without <p> element inside it', function() {
		...
		.then(function(transformedXml) {
			transformedXml.should.equal(
				'<aside class="n-content-box n-content-box--inline n-content-u-border--all" data-trackable="related-box" role="complementary">' +
					'<div class="n-content-box__title"><div class="n-content-box__title-text n-content-u-background-color--pink"><b>CV</b></div></div>' +
					'<div class="aside--headline n-content-u-margin--left-right">This is the headline</div>' +
					'<div class="aside--content n-content-u-margin--left-right"><p>Here is some content</p></div>' +
				'</aside>\n'
			);
		});
	});
		...
		.then(function(transformedXml) {
			transformedXml.should.equal(
				'<aside class="n-content-box n-content-box--inline n-content-u-border--all" data-trackable="related-box" role="complementary">' +
					'<div class="n-content-box__title"><div class="n-content-box__title-text n-content-u-background-color--pink">Tatomer Riesling 2012</div></div>' +
					'<div class="aside--headline n-content-u-margin--left-right">Greece debt crisis</div>' +
					'<div class="aside--image n-content-u-margin--left-right"><div class="n-content-image__placeholder" style="padding-top:96px;">' +
					...
					'<div class="aside--content n-content-u-margin--left-right"><p>That should do it.</p></div>' +
				'</aside>\n'
			);
		});
