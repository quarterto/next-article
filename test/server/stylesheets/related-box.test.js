...
describe('Related Box', () => {
		...
		.then(transformedXml => {
			transformedXml.should.equal(
				'<aside class="n-content-box n-content-box--inline n-content-u-border--all" data-trackable="related-box" role="complementary">' +
					'<div class="aside--headline n-content-u-margin--left-right"><a data-trackable="link-headline" href="https://live.ft.com/Events/2015/FT-Property-Summit-2015">9th Annual Property Summit</a></div>' +
					...
					'<div class="aside--content n-content-u-margin--left-right"><p>The Financial Times is delighted to present the 9th annual <strong>FT Property Summit</strong></p>' +
	...
	it('should put in the appropriate mark up for a related box that is not an article with existing mark up - no url', () => {
		...
		.then(transformedXml => {
			transformedXml.should.equal(
				'<aside class="n-content-box n-content-box--inline n-content-u-border--all" data-trackable="related-box" role="complementary">' +
					'<div class="aside--headline n-content-u-margin--left-right">9th Annual Property Summit</div>' +
	...
	it('should put in the appropriate mark up for a related box that is not an article with existing mark up - with title', () => {
		...
		.then(transformedXml => {
			transformedXml.should.equal(
				'<aside class="n-content-box n-content-box--inline n-content-u-border--all" data-trackable="related-box" role="complementary">' +
					'<div class="n-content-box__title"><div class="n-content-box__title-text n-content-u-background-color--pink">FT Property Summit 2015</div></div>' +
					'<div class="aside--headline n-content-u-margin--left-right"><a data-trackable="link-headline" href="https://live.ft.com/Events/2015/FT-Property-Summit-2015">9th Annual Property Summit</a></div>' +
					'<div class="aside--image"><a data-trackable="link-image" href="https://live.ft.com/Events/2015/FT-Property-Summit-2015"><div class="n-content-image__placeholder" style="padding-top:56.25%;">' +
					'<img alt="Housing market economic dashboard" src="https://next-geebee.ft.com/image/v1/images/raw/http://com.ft.imagepublish.prod.s3.amazonaws.com/aa4eec2e-1bfd-11e5-8201-cbdb03d71480?source=next&amp;fit=scale-down&amp;width=470"></div></a></div>' +
					'<div class="aside--content n-content-u-margin--left-right"><p>The Financial Times is delighted to present the 9th annual <strong>FT Property Summit</strong></p>' +
		...
		.then(transformedXml => {
			transformedXml.should.equal(
				'<aside class="n-content-box n-content-box--inline n-content-u-border--all" data-trackable="related-box" role="complementary">' +
					'<div class="n-content-box__title"><div class="n-content-box__title-text n-content-u-background-color--pink">FT Property Summit 2015</div></div>' +
					'<div class="aside--headline n-content-u-margin--left-right"><a data-trackable="link-headline" href="https://live.ft.com/Events/2015/FT-Property-Summit-2015">9th Annual Property Summit</a></div>' +
					'<div class="aside--image n-content-u-margin--left-right"><a data-trackable="link-image" href="https://live.ft.com/Events/2015/FT-Property-Summit-2015"><div class="n-content-image__placeholder" style="padding-top:96px;">' +
	...
	it('should add the appropriate mark up for a related box that is an article with without a title', () => {
		...
		.then(transformedXml => {
			transformedXml.should.equal(
				'<aside class="n-content-box n-content-box--inline n-content-u-border--all" data-trackable="related-box" role="complementary">' +
						'<div class="n-content-box__title"><div class="n-content-box__title-text n-content-u-background-color--pink">Related article</div></div>' +
						...
						'<img alt="Housing market economic dashboard" src="https://next-geebee.ft.com/image/v1/images/raw/http://com.ft.imagepublish.prod.s3.amazonaws.com/aa4eec2e-1bfd-11e5-8201-cbdb03d71480?source=next&amp;fit=scale-down&amp;width=470"></div></a></div>' +
						'<div class="aside--headline n-content-u-margin--left-right"><a data-trackable="link-headline" href="/content/e539eab8-8c83-11e5-8be4-3506bf20cc2b">9th Annual Property Summit</a></div>' +
						'<div class="aside--content n-content-u-margin--left-right"><p>The Financial Times is delighted to present the 9th annual <strong>FT Property Summit</strong></p>' +
						'<p>This will bring together global investors, occupiers, lenders and developers to explore the opportunities available in the UK commercial property market</p></div>' +
				'</aside>\n'
			);
	...
	it('should add the appropriate mark up for a related box that is an article with with a title', () => {
		...
		.then(transformedXml => {
			transformedXml.should.equal(
				'<aside class="n-content-box n-content-box--inline n-content-u-border--all" data-trackable="related-box" role="complementary">' +
					'<div class="n-content-box__title"><div class="n-content-box__title-text n-content-u-background-color--pink">Bridge the generation gap</div></div>' +
					'<div class="aside--image"><a data-trackable="link-image" href="/content/e539eab8-8c83-11e5-8be4-3506bf20cc2b"><div class="n-content-image__placeholder" style="padding-top:56.25%;">' +
					'<img alt="Housing market economic dashboard" src="https://next-geebee.ft.com/image/v1/images/raw/http://com.ft.imagepublish.prod.s3.amazonaws.com/aa4eec2e-1bfd-11e5-8201-cbdb03d71480?source=next&amp;fit=scale-down&amp;width=470"></div></a></div>' +
					'<div class="aside--headline n-content-u-margin--left-right"><a data-trackable="link-headline" href="/content/e539eab8-8c83-11e5-8be4-3506bf20cc2b">9th Annual Property Summit</a></div>' +
					'<div class="aside--content n-content-u-margin--left-right"><p>The Financial Times is delighted to present the 9th annual <strong>FT Property Summit</strong></p>' +
